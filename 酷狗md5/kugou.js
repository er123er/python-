...
o = ['NVPh5oo715z5DIWAeQlhMDsWXXQV4hwt', 'callback=callback123', 'clienttime=1660369925855', 'clientver=2000', 'dfid=-', 'iscorrection=1', 'keyword=周杰伦', 'mid=1660369925855', 'page=1', 'pagesize=30', 'platform=WebFilter', 'privilege_filter=0', 'srcappid=2919', 'userid=0', 'uuid=1660369925855', 'NVPh5oo715z5DIWAeQlhMDsWXXQV4hwt']
// // console.log(o.join(""))
console.log(faultylabs.MD5(o.join("")))
